...
enum L10n {
    ...
    private static let table: [Lang: [String: String]] = [
        .en: [
            "notifications": "Notifications", "notificationsIntro": "What the island announces with a toast. Everything else still shows on it quietly.",
            "notifyAbout": "Tell me when", "notifyHow": "How",
            "notifyDone": "A long command finishes", "notifyFailed": "A long command fails",
            "notifyWaiting": "An agent or a script waits for my answer", "notifyAgentDone": "An agent finishes its turn",
            "notifyTasks": "A notch task finishes", "notifyUpdates": "A new version is out",
            "systemNotificationsHint": "Also into Notification Center, for when you are away from the screen.",
            "checkUpdates": "Check for updates", "checkUpdatesAuto": "Check automatically every hour",
            "updateChecking": "Checking…", "updateNone": "You have the latest version",
            "updateAvailable": "Notchline {v} is available", "updateDownload": "Download",
            "updateFailed": "Could not reach GitHub", "updateTap": "Click to download",
            "updateMenu": "Download Notchline {v}…",
            ...
            "sources": "Check", "guardAnnounce": "The shell enters production",
            ...
            "behaviour": "Behaviour",
            "showAfter": "Show commands longer than", "notifyAfter": "Long means longer than",
            "seconds": "{n} s",
        ...
        .ru: [
            "notifications": "Уведомления", "notificationsIntro": "О чём остров сообщает тостом. Всё остальное он по-прежнему показывает тихо.",
            "notifyAbout": "Сообщать, когда", "notifyHow": "Как",
            "notifyDone": "Долгая команда завершилась", "notifyFailed": "Долгая команда упала с ошибкой",
            "notifyWaiting": "Агент или скрипт ждёт моего ответа", "notifyAgentDone": "Агент закончил ход",
            "notifyTasks": "Задача notch завершилась", "notifyUpdates": "Вышла новая версия",
            "systemNotificationsHint": "Ещё и в Центр уведомлений — на случай, если вы отошли от экрана.",
            "checkUpdates": "Проверить обновления", "checkUpdatesAuto": "Проверять автоматически каждый час",
            "updateChecking": "Проверяем…", "updateNone": "У вас последняя версия",
            "updateAvailable": "Доступна Notchline {v}", "updateDownload": "Скачать",
            "updateFailed": "Не удалось связаться с GitHub", "updateTap": "Нажмите, чтобы скачать",
            "updateMenu": "Скачать Notchline {v}…",
            ...
            "sources": "Проверять", "guardAnnounce": "Терминал вошёл в прод",
            ...
            "behaviour": "Поведение",
            "showAfter": "Показывать команды дольше", "notifyAfter": "Долгая — это дольше",
            "seconds": "{n} с",
        ...
        .zh: [
            "notifications": "通知", "notificationsIntro": "刘海会用提示告知哪些事情。其他内容仍会安静地显示。",
            "notifyAbout": "在以下情况提醒我", "notifyHow": "方式",
            "notifyDone": "长时间命令完成", "notifyFailed": "长时间命令失败",
            "notifyWaiting": "智能体或脚本等待我的回复", "notifyAgentDone": "智能体完成一轮",
            "notifyTasks": "notch 任务完成", "notifyUpdates": "有新版本",
            "systemNotificationsHint": "同时发送到通知中心，以便你离开屏幕时也能看到。",
            "checkUpdates": "检查更新", "checkUpdatesAuto": "每小时自动检查",
            "updateChecking": "正在检查…", "updateNone": "已是最新版本",
            "updateAvailable": "Notchline {v} 已发布", "updateDownload": "下载",
            "updateFailed": "无法连接 GitHub", "updateTap": "点击下载",
            "updateMenu": "下载 Notchline {v}…",
            "height": "高度", "width": "宽度",
            ...
            "sources": "检查", "guardAnnounce": "终端进入生产环境",
            ...
            "behaviour": "行为",
            "showAfter": "显示运行超过以下时长的命令", "notifyAfter": "长时间指超过",
            "seconds": "{n} 秒",
            "sound": "命令结束时播放声音",
